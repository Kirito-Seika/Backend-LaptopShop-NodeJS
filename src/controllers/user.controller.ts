...
import { fetchAllUser, handleCreateUser, handleDeleteUser, handleViewUser } from "services/user.service";
...
export { getHomePage, createUserPage, createUser, deleteUser, viewUserPage };